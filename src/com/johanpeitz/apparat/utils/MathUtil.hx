...
class MathUtil {
	 ...
	 * A double PI.
	 */
	public static var TWO_PI : Float = PI * 2;
	/**
	 ...
	 */
	public static function randomFloat( pMin : Float, pMax : Float ) : Float {
	...
	public static function randomInt( pMin : Int, pMax : Int ) : Int {
		return Std.int( pMin + ( pMax - pMin ) * Math.random() );
	}
